...
function Movie() {
    ...
    const getMovieFilters = () => {
        ...
        return fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${import.meta.env.VITE_TMDB_API_KEY}&vote_count.gte=200&with_genres=${genero}&vote_average.gte=${notaMin}&vote_average.lte=${notaMax}&primary_release_date.gte=${dataMin}&primary_release_date.lte=${dataMax}&with_watch_providers=${streaming}&language=pt-BR&page=${paginaAleatoria}`)
            .then(res => res.json())
            .then(json => {
        ...
        <section>
            <div className="sort-content" id="sorteador">
                <div className="section-title">
                    ...
                    <p>Configure os filtros abaixo e clique no botao para sortear.</p>
                </div>
                <div className="sorter-layout">
                    <div className="control-panel">
                        ...
                        <div className="select-group">
                            ...
                            <label className="select-label">Data de lançamento</label>
